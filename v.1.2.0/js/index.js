(function() {
  angular.module('angularMaterialTableApp', ['ngMdTables', 'ngMaterial']).controller('MainCtrl', function($scope, $timeout) {
    ...
    {
        "name": "sr-only",
        "description": "position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0"
    },
    {
        "name": "not-sr-only",
        "description": "position: static; width: auto; height: auto; padding: 0; margin: 0; overflow: visible; clip: auto; white-space: normal;"
    },
    {
        "name": "focus:sr-only",
        "description": "position: absolute; width: 1px; height: 1px; padding: 0; margin: -1px; overflow: hidden; clip: rect(0"
    ...
    {
        "name": "border-double",
        "description": "border-style: double;"
    },
    {
        "name": "border-none",
    ...
    {
        "name": "font-sans",
        "description": "font-family: -apple-system"
    },
    {
        "name": "font-serif",
    ...
    {
        "name": "focus:opacity-0",
        "description": "opacity: 0;"
    },
    {
        "name": "focus:opacity-25",
        "description": "opacity: 0.25;"
    },
    {
        "name": "focus:opacity-50",
        "description": "opacity: 0.5;"
    },
    {
        "name": "focus:opacity-75",
        "description": "opacity: 0.75;"
    },
    {
        "name": "focus:opacity-100",
        "description": "opacity: 1;"
    },
    {
        "name": "outline-none",
    ...
    {
        "name": "shadow",
        "description": "box-shadow: 0 1px 3px 0 rgba(0"
    },
    {
        "name": "shadow-md",
        "description": "box-shadow: 0 4px 6px -1px rgba(0"
    },
    {
        "name": "shadow-lg",
        "description": "box-shadow: 0 10px 15px -3px rgba(0"
    },
    {
        "name": "shadow-xl",
        "description": "box-shadow: 0 20px 25px -5px rgba(0"
    },
    {
        "name": "shadow-2xl",
        "description": "box-shadow: 0 25px 50px -12px rgba(0"
    },
    {
        "name": "shadow-inner",
        "description": "box-shadow: inset 0 2px 4px 0 rgba(0"
    },
    {
        "name": "shadow-outline",
        "description": "box-shadow: 0 0 0 3px rgba(66"
    },
    {
        "name": "shadow-none",
    ...
    {
        "name": "w-5/6",
        "description": "width: 83.333333%;"
    },
    {
        "name": "w-1/12",
        "description": "width: 8.333333%;"
    },
    {
        "name": "w-2/12",
        "description": "width: 16.666667%;"
